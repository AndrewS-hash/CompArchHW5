...
riscv64-unknown-elf-g++ -c -mabi=ilp32 -march=rv32im -DUSE_MYSTDLIB -DTIME -DRISCV -g HW05.cpp -o HW05.o
riscv64-unknown-elf-ld -nostdlib -T rv32im.ls boot.o stdlib.o HW05.o -o HW05.elf
